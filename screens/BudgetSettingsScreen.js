        ...
        >
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.currentBudgetCard}>
              <Text style={styles.currentBudgetLabel}>Current Monthly Budget</Text>
            ...
            <View style={styles.inputContainer}>
              <Ionicons name="wallet" size={20} color={LightTheme.colors.primary} style={styles.inputIcon} />
              <TextInput
            ...
            <View style={styles.tipsContainer}>
              ...
              <Text style={styles.tipText}>• Set a realistic budget based on your income</Text>
              <Text style={styles.tipText}>• Consider your fixed expenses (rent, bills)</Text>
              <Text style={styles.tipText}>• Leave room for unexpected expenses</Text>
